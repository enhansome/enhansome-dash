...
* [Awesome React](https://github.com/enaqx/awesome-react) ⭐ 74,463 | 🐛 89 | 📅 2026-08-20 - Helpful resources for developing React.js components.
* [Awesome React Components](https://github.com/brillout/awesome-react-components) ⭐ 48,314 | 🐛 87 | 📅 2026-01-26 - Catalog of React.js components potentially interesting to be wrapped into Dash components.
...
* [dj-plotly-dash](https://github.com/pikhovkin/dj-plotly-dash) ⭐ 60 | 🐛 305 | 🌐 JavaScript | 📅 2026-08-29 - Plotly Dash fork for Django.
...
* [dash-flexbox-grid](https://github.com/pikhovkin/dash-flexbox-grid) ⭐ 20 | 🐛 13 | 🌐 Python | 📅 2026-09-02 - Wrapper around react-flexbox-grid for Plotly Dash.
* [Dash MUI](https://github.com/ploomber/dash-mui) ⭐ 19 | 🐛 4 | 🌐 JavaScript | 📅 2024-11-06 - Material UI components
* [Dash Mosaic](https://github.com/ploomber/mosaic-python#dash-mosaic) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2024-10-04 - Display [Mosaic](https://github.com/uwdata/mosaic) ⭐ 1,367 | 🐛 84 | 🌐 TypeScript | 📅 2026-09-01 plots
