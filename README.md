...
* [Awesome React](https://github.com/enaqx/awesome-react) ⭐ 74,591 | 🐛 9 | 📅 2026-09-04 - Helpful resources for developing React.js components.
* [Awesome React Components](https://github.com/brillout/awesome-react-components) ⭐ 48,406 | 🐛 91 | 📅 2026-01-26 - Catalog of React.js components potentially interesting to be wrapped into Dash components.
...
* [dash-flexbox-grid](https://github.com/pikhovkin/dash-flexbox-grid) ⭐ 20 | 🐛 13 | 🌐 Python | 📅 2026-09-14 - Wrapper around react-flexbox-grid for Plotly Dash.
* [Dash MUI](https://github.com/ploomber/dash-mui) ⭐ 19 | 🐛 4 | 🌐 JavaScript | 📅 2024-11-06 - Material UI components
* [Dash Mosaic](https://github.com/ploomber/mosaic-python#dash-mosaic) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2024-10-04 - Display [Mosaic](https://github.com/uwdata/mosaic) ⭐ 1,370 | 🐛 117 | 🌐 TypeScript | 📅 2026-09-13 plots
