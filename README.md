...
* [Awesome React](https://github.com/enaqx/awesome-react) ⭐ 74,361 | 🐛 82 | 📅 2026-08-20 - Helpful resources for developing React.js components.
* [Awesome React Components](https://github.com/brillout/awesome-react-components) ⭐ 48,241 | 🐛 81 | 📅 2026-01-26 - Catalog of React.js components potentially interesting to be wrapped into Dash components.
...
* [dash-flexbox-grid](https://github.com/pikhovkin/dash-flexbox-grid) ⭐ 20 | 🐛 13 | 🌐 Python | 📅 2026-08-21 - Wrapper around react-flexbox-grid for Plotly Dash.
* [Dash MUI](https://github.com/ploomber/dash-mui) ⭐ 19 | 🐛 4 | 🌐 JavaScript | 📅 2024-11-06 - Material UI components
* [Dash Mosaic](https://github.com/ploomber/mosaic-python#dash-mosaic) ⭐ 14 | 🐛 0 | 🌐 Python | 📅 2024-10-04 - Display [Mosaic](https://github.com/uwdata/mosaic) ⭐ 1,362 | 🐛 81 | 🌐 TypeScript | 📅 2026-08-19 plots
